    ...
    for epoch in range(num_epochs):
        ...
        if valid_data is not None:
            ...
            if valid_acc / len(valid_data)>best_acc:
                ...
                torch.save( net.state_dict(), 'models/{}-{}-{}-0819-model_data-db.pth'.format(saver_prefix ,epoch + 1,int(best_acc*1000) ) )
        else:
        ...
        #     # torch.save(net,'models/vgg-16-'+str(epoch+1)+'-model_data.pth')
        #     # another weight saver method
        #     torch.save(net.state_dict(),'models/{}-{}-0711-model_data.pth'.format(saver_prefix, epoch+1))
