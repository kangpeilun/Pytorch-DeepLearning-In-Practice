...
class ColorizationModel(Pix2PixModel):
    ...
    The model_data training requires '-dataset_model colorization' dataset.
    It trains a pix2pix model_data, mapping from L channel to ab channels in Lab color space.
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        By default, we use 'colorization' dataset for this model_data.
